...
/**
 * Created by MSP on 7/6/2017.
 */

public class My_Appointment_Lawyer_Adapter extends ArrayAdapter<String> {
    ...
    public My_Appointment_Lawyer_Adapter(Context context, ArrayList<String> mAppointmentDate, ArrayList<String> mAppointmentTime, ArrayList<String> mAppointmentType, ArrayList<String> mLawyerName, ArrayList<String> mLocationAddress) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mAppointmentType.get(position).equals(OFFICE_APPOINTMENT))
            ...
            holder.mTxt.setText("You have an appointment at Your Location:\nLawyer Name:" + mLawyerName.get(position) + "\nLocation:" + mLocationAddress.get(position) + "\nBooking Date:" + mAppointmentDate.get(position) + "\nTime:" + mAppointmentTime.get(position));
