...
public class Review_Adapter_Profile extends ArrayAdapter<String> {
    ...
    public Review_Adapter_Profile(Context context, ArrayList<String> name,
                          ArrayList<String> review,
                          ArrayList<Float> rating) {
        super(context, R.layout.review_adapter_profile, name);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.review_adapter_profile, null);
        }
